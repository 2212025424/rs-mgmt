...
class RepositorioCategoriaInsumo {

    private static $INSERTAR_CATEGORIA = "INSERT INTO CategoriaInsumo SET clave=:clave, categoria=:categoria";
    private static $OBTENER_CATEGORIAS = "SELECT * FROM CategoriaInsumo ORDER BY categoria";
    private static $ELIMINAR_CATEGORIA_POR_CLAVE = "DELETE FROM CategoriaInsumo WHERE clave=:clave";
    private static $ACTUALIZAR_CATEGORIA_POR_CLAVE = "UPDATE CategoriaInsumo SET categoria=:categoria WHERE clave=:clave";
    private static $OBTENER_CATEGORIA_POR_CLAVE = "SELECT * FROM CategoriaInsumo WHERE clave=:clave";
    private static $OBTENER_CATEGORIA_POR_CATEGORIA = "SELECT * FROM CategoriaInsumo WHERE categoria=:categoria";
    ...
    public static function insertar_categoria($categoria_obj, $conexion) {
        ...
        if (isset($conexion)) {
            try {
                ...
                $mesa = htmlspecialchars($categoria_obj->getCategoria());
